...
int main() {
	...
	//double *num_entries = (double *)malloc(sizeof(double) * N*M);
	//double *csr_rowoffsets = (double *)malloc(sizeof(double) * N*M + 1);
	
	int* device_num_entries;
	cudaMalloc(&device_num_entries, sizeof(int) * N*M);
	//double* device_num_entries;
	//cudaMalloc(&device_num_entries, sizeof(double) * N*M);
	
	int* device_csr_rowoffsets;
	cudaMalloc(&device_csr_rowoffsets, sizeof(int) * N*M);
	//double* device_csr_rowoffsets;
	//cudaMalloc(&device_csr_rowoffsets, sizeof(double) * N*M + 1);
	...
	//cudaMemcpy(device_num_entries, num_entries, sizeof(double) * N*M, cudaMemcpyHostToDevice);
	...
	//cudaMemcpy(csr_rowoffsets, device_csr_rowoffsets, sizeof(double) * N*M, cudaMemcpyDeviceToHost);
