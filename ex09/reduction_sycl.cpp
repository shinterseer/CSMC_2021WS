  // Reference: https://www.codingame.com/playgrounds/48226/introduction-to-sycl/using-local-memory-barriers-and-writing-the-result
  ...
  int main(int, char**) {
    ...
    while (len != 1) {
       ...
       queue.submit([&] (sycl::handler& cgh) {
          ...
          cgh.parallel_for<class reduction_kernel>(  // kernel entry point
            ...
            item.barrier(sycl::access::fence_space::local_space); // Barrier for all threads to wait
	    ...
	    // write result of local reduction
            if (local_id == 0) {
